...
T Matrix<T, 2, 2>::absmin() const {
    return ::std::absmin(::std::absmin(_elements[0], _elements[1]),
                         ::std::absmin(_elements[2], _elements[3]));
}

template <typename T>
T Matrix<T, 2, 2>::absmax() const {
    return ::std::absmax(::std::absmax(_elements[0], _elements[1]),
                         ::std::absmax(_elements[2], _elements[3]));
}
